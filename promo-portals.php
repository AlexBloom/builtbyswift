<?php if( get_field('promo_portals', 886) ) : ?>
		<section class="promo-portals">
			<div class="promo-portal portal">
				<?php $page_banner = wp_get_attachment_image_src(get_field('featured_area_1_image', 886), 'original'); ?>
				...
				<a href="<?php the_field('featured_area_1_link', 886); ?>">
					<picture class="picture">
						...
						<!-- <source
							srcset=" echo $mobile_page_banner[0]; "
							media="(max-width: 500px)" /> -->
						<!-- <source
							srcset=" echo $tablet_page_banner[0]; "
							media="(min-width: 500px)" /> -->
						<!--[if IE 9]></video><![endif]-->
						<!-- <img srcset=" echo $image[0]; "> -->
						<img src="<?php echo $page_banner[0]; ?>">
					</picture>
				</a>
			...
			<div class="promo-portal portal">
				<?php $page_banner = wp_get_attachment_image_src(get_field('featured_area_2_image', 886), 'original'); ?>
